...
export default function Page() {
  return (
    <section>
      ...
      <div className="max-w-6xl mx-auto mb-12 flex flex-col md:flex-row items-start gap-10">
        {/* Text Section */}
        ...
        <div className="md:w-1/3 flex justify-center md:justify-end">
          <Image
            src="/images/Simons_Kailey.jpg"
            alt="Kailey Simons"
            width={600}
            height={600}
            className="rounded-lg object-cover w-full h-auto max-w-[375px]"
          />
        </div>
      </div>
